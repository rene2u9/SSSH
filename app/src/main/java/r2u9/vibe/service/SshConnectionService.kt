...
import r2u9.vibe.MainActivity
import r2u9.vibe.R
import r2u9.vibe.data.model.ActiveSession
import r2u9.vibe.data.model.SshConnection
import r2u9.vibe.ssh.SshManager
import r2u9.vibe.ssh.SshSession
import r2u9.vibe.terminal.TerminalEmulator
...
class SshConnectionService : Service() {
    ...
    companion object {
        ...
        const val GROUP_KEY = "r2u9.vibe.SSH_SESSIONS"
        const val ACTION_DISCONNECT_ALL = "r2u9.vibe.DISCONNECT_ALL"
        const val ACTION_DISCONNECT_SESSION = "r2u9.vibe.DISCONNECT_SESSION"
        const val ACTION_OPEN_SESSION = "r2u9.vibe.OPEN_SESSION"
